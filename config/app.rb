...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-project.com'
  config.app_name = 'Volt_project'
  config.mailer.from = 'Volt_project <no-reply@volt-project.com>'
  ...
  #
  config.app_secret = 'Qh5ZTcAfe3jZXJbT7UoCPA8jyTPQQ4GQddYe1gDS-b2GEV-FVat08JkKjlPzKIIBrdI'
